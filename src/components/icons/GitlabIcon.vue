<template>
  <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none" v-bind="$attrs">
    <title>GitLab</title>
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      ></path>
      <path fill="#b2c4f5" d="M8 14.296l2.578-7.75H5.423L8 14.296z"></path>
      <path fill="currentColor" d="M8 14.296l-2.579-7.75H1.813L8 14.296z"></path>
      <path
        fill="#e6ebf9"
      ...
      ></path>
      <path fill="currentColor" d="M8 14.296l2.578-7.75h3.614L8 14.296z"></path>
      <path
        fill="#e6ebf9"
