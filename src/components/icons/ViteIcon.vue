<template>
  <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" v-bind="$attrs">
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      <defs>
        ...
        >
          <stop stop-color="#e2e8fb"></stop>
          <stop offset="1" stop-color="#ccd6f6"></stop>
        </linearGradient>
        <linearGradient
          id="paint1_linear"
          x1="194.651"
          ...
          gradientTransform="matrix(.07142 0 0 .07142 1.3398 1.8944)"
        >
          <stop stop-color="#ccd6f6"></stop>
          <stop offset=".5" stop-color="#b7c4f0"></stop>
          <stop offset="1" stop-color="#a9b6e3"></stop>
        </linearGradient>
      </defs>
    </g>
  </svg>
